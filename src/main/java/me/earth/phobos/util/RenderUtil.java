...
public class RenderUtil implements Util
{
    ...
    public static void drawBoxESP(final BlockPos pos, final Color color, final boolean secondC, final Color secondColor, final float lineWidth, final boolean outline, final boolean box, final int boxAlpha, final boolean air, final double height) {
        if (box) {
    ...
    public static void drawText(final BlockPos pos, final String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-(Phobos.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
    ...
    public static void blockEsp(final BlockPos blockPos, final Color c, final double length, final double length2) {
        final double x = blockPos.getX() - RenderUtil.mc.getRenderManager().viewerPosX;
        final double y = blockPos.getY() - RenderUtil.mc.getRenderManager().viewerPosY;
        final double z = blockPos.getZ() - RenderUtil.mc.getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
    ...
    public static void drawSphere(final double x, final double y, final double z, final float size, final int slices, final int stacks) {
        ...
        GL11.glTranslated(x - RenderUtil.mc.getRenderManager().viewerPosX, y - RenderUtil.mc.getRenderManager().viewerPosY, z - RenderUtil.mc.getRenderManager().viewerPosZ);
